        ...
        <footer className="py-24 px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-3 gap-20 mb-24">
              ...
              <div>
                <div className="text-xs font-semibold uppercase tracking-[0.2em] text-black/45 mb-8">Info</div>
                <ul className="space-y-4 text-base text-black/60 font-extralight">
                  <li><span className="text-black/50">5 AI Models</span></li>
                  <li><span className="text-black/50">HTTP 402</span></li>
                  <li><span className="text-black/50">From $0.03</span></li>
                </ul>
              </div>
            </div>
