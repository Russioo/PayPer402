    ...
    <div className="min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-8">
          ...
          >
            <div className="inline-block px-4 sm:px-6 py-2 sm:py-2.5 bg-black/5 backdrop-blur-sm mb-6 sm:mb-8 md:mb-12">
              <span className="text-[10px] sm:text-xs uppercase tracking-[0.15em] sm:tracking-[0.2em] text-black/40 font-medium">HTTP 402 • Pay-per-use AI</span>
            </div>
            <h1 className="text-[42px] sm:text-[60px] md:text-[80px] lg:text-[110px] font-extralight text-black mb-6 sm:mb-10 md:mb-16 tracking-[-0.02em] leading-[0.9] sm:leading-[0.85]">
              Professional<br/>AI Content
            </h1>
            <p className="text-base sm:text-xl md:text-2xl lg:text-3xl text-black/25 font-extralight leading-relaxed max-w-3xl mx-auto mb-10 sm:mb-14 md:mb-20 px-4">
              Generate videos & images with Sora 2, Veo 3.1, and more. Pay only for what you use via 402 protocol.
            </p>
            <a 
              href="#generate"
              className="group inline-flex items-center gap-3 sm:gap-4 px-6 sm:px-8 md:px-10 py-3.5 sm:py-4 md:py-5 bg-black text-white text-xs sm:text-sm font-medium tracking-wider hover:bg-black/90 transition-all duration-300 hover:gap-4 sm:hover:gap-6"
            >
        ...
        {/* Stats Section */}
        <section className="py-20 sm:py-32 md:py-40 lg:py-48 px-4 sm:px-6 md:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-3 gap-6 sm:gap-12 md:gap-20 lg:gap-32">
              {[
                ...
                >
                  <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extralight text-black mb-3 sm:mb-4 md:mb-6 transition-colors duration-300 group-hover:text-indigo-600">{stat.value}</div>
                  <div className="text-[10px] sm:text-xs md:text-sm text-black/15 uppercase tracking-[0.15em] sm:tracking-[0.2em] font-medium">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Generator Section */}
        <section id="generate" className="py-20 sm:py-32 md:py-40 lg:py-48 px-4 sm:px-6 md:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 sm:mb-24 md:mb-32 lg:mb-40">
              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extralight text-black mb-4 sm:mb-6 md:mb-10 tracking-tight">Start Generating</h2>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-black/20 font-extralight px-4">
            ...
            {!connected && (
              <div className="relative">
                <div className="absolute inset-0 z-20 flex items-center justify-center backdrop-blur-sm bg-white/60 p-4">
                  <div className="text-center p-6 sm:p-10 md:p-16 bg-white border-2 border-black/10 max-w-xl w-full">
                    <Wallet className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto mb-6 sm:mb-8 text-black/20" />
                    <h3 className="text-2xl sm:text-2xl md:text-3xl font-extralight text-black mb-4 sm:mb-6">Connect Your Wallet</h3>
                    <p className="text-sm sm:text-base text-black/40 mb-8 sm:mb-10 leading-relaxed px-2">
                      To use PayPer402 and pay with USDC on Solana network, 
                      you need to connect your wallet first.
                    </p>
                    <WalletMultiButton className="!bg-black !text-white hover:!bg-black/90 !text-sm sm:!text-base !font-medium !py-3 sm:!py-4 !px-6 sm:!px-8 !rounded-none transition-all duration-300" />
                    <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-black/5">
                      <p className="text-[10px] sm:text-xs text-black/25 uppercase tracking-[0.15em] sm:tracking-[0.2em]">
                ...
                <div className="filter blur-md pointer-events-none select-none">
                  <div className="grid lg:grid-cols-12 gap-8 sm:gap-12 md:gap-16 lg:gap-24">
                    <div className="lg:col-span-6 space-y-8 sm:space-y-12 md:space-y-20">
                      <div className="h-24 sm:h-28 md:h-32 bg-black/5"></div>
                      <div className="space-y-4">
                        <div className="h-20 sm:h-22 md:h-24 bg-black/5"></div>
                        <div className="h-20 sm:h-22 md:h-24 bg-black/5"></div>
                      </div>
                    </div>
            ...
            {connected && (
              <div className="grid lg:grid-cols-12 gap-12 sm:gap-16 md:gap-20 lg:gap-24">
              {/* Left */}
              <div className="lg:col-span-6 space-y-10 sm:space-y-12 md:space-y-16 lg:space-y-20">
                {/* Type Selector */}
                <div className="opacity-0 animate-slide-up" style={{ animationDelay: '100ms', animationFillMode: 'forwards' }}>
                  <h3 className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-black/35 mb-6 sm:mb-8 md:mb-10">Type</h3>
                  <div className="flex gap-4 sm:gap-6 md:gap-8">
                    {['image', 'video'].map((type) => (
                      <button
                        ...
                        className={`
                          group relative flex-1 py-4 sm:py-5 md:py-6 text-base sm:text-lg md:text-xl font-extralight transition-all duration-300
                          ${activeTab === type
                            ? 'text-black' 
                ...
                <div className="opacity-0 animate-slide-up" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
                  <h3 className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-black/35 mb-6 sm:mb-8 md:mb-10">Model</h3>
                ...
                {selectedModel && (
                  <div className="opacity-0 animate-slide-up" style={{ animationDelay: '400ms', animationFillMode: 'forwards' }}>
                    <h3 className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-black/35 mb-6 sm:mb-8 md:mb-10">Prompt</h3>
                    <GenerationForm
              ...
              <div className="lg:col-span-6">
                <div className="lg:sticky lg:top-32 opacity-0 animate-slide-up" style={{ animationDelay: '500ms', animationFillMode: 'forwards' }}>
                  <h3 className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-black/35 mb-6 sm:mb-8 md:mb-10">Output</h3>
                  {result ? (
                    <ResultDisplay
                      type={result.type}
                      url={result.url}
                    ...
                    <div className="relative aspect-square border border-black/5 overflow-hidden group">
                      ...
                      <div className="relative h-full flex flex-col items-center justify-center px-12">
                        ...
                        <div className="text-center space-y-3 sm:space-y-4 px-4">
                          <p className="text-base sm:text-lg md:text-xl text-black/30 font-extralight tracking-wide">
                            Select a model
                          </p>
                          <p className="text-xs sm:text-sm text-black/15 font-light tracking-wider uppercase">
        ...
        {/* Footer */}
        <footer className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 sm:gap-12 md:gap-16 lg:gap-20 mb-12 sm:mb-16 md:mb-20 lg:mb-24">
              <div>
                <div className="font-semibold text-black mb-4 sm:mb-6 md:mb-8 text-xl sm:text-xl md:text-2xl">PayPer402</div>
                <p className="text-sm sm:text-base text-black/60 leading-relaxed font-extralight">
                  Professional AI generation platform powered by leading models. 
                  Pay per use with HTTP 402 protocol.
                </p>
              </div>
              <div>
                <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-black/45 mb-4 sm:mb-6 md:mb-8">Platform</div>
                <ul className="space-y-3 sm:space-y-4 text-sm sm:text-base text-black/60 font-extralight">
              ...
              <div>
                <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-black/45 mb-4 sm:mb-6 md:mb-8">Community</div>
                <ul className="space-y-3 sm:space-y-4 text-sm sm:text-base text-black/60 font-extralight">
                  <li>
                    <a 
            ...
            <div className="pt-6 sm:pt-8 md:pt-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 text-xs sm:text-sm text-black/40 font-extralight">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6">
                ...
                <span className="text-xs sm:text-sm">Powered by HTTP 402 Payment Protocol</span>
              </div>
            </div>
          </div>
        </footer>
