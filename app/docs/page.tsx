        ...
        <main className="pt-32 pb-24 px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-16">
              ...
              {/* Support & Community */}
              <section>
                <h2 className="text-4xl font-light text-black mb-6">Support & Community</h2>
                <div className="space-y-4 text-black/40 leading-relaxed">
                  <p>
                  ...
                  <div className="bg-black/5 p-6 mt-8">
                    <h3 className="text-xl font-medium text-black mb-4">Open Source</h3>
                    <p className="mb-4">
                    ...
                    <div className="flex gap-4">
                      <a 
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-black text-white hover:bg-black/80 transition-colors duration-300"
                      >
